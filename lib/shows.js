...
export const GENRES = [
  {
    ...
    style:
      ...
      'bright ring-lit adult pitchman in a headset microphone talking clearly and ' +
...
export function templatePrompt(concept) {
  if (concept.genre === 'live-shopping') {
    return (
      ...
      `The adult pitchman demonstrates the product to a phone camera and addresses ` +
      `the viewer directly, with big gestures and total conviction. ` +
      `He speaks at a normal, clear conversational pace — enthusiastic, never rushed, ` +
      `leaving beats between sentences. ` +
