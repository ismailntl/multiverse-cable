...
// Only claim the lock when the JSON store is actually the backend. It used to
// run at import, which crashed boot on a host using Postgres (and on any
// read-only filesystem) for a lock nothing needed.
let lockClaimed = false;
export function ensureLock() {
