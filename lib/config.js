...
export const config = {
  ...
  // fal's post-trained MiniMax H3 Max: fast, high quality, and the only
  // backend here that returns a synchronized audio track.
  falModel: process.env.FAL_MODEL || 'minimax/h3-max/image-to-video',
